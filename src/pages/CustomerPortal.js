...
const CustomerPortal = () => {
  ...
  const ProductCard = ({ product }) => (
    <div className="bg-white border-2 border-gray-200 rounded-xl p-4 hover:shadow-lg hover:border-blue-300 transition-all duration-300 transform hover:-translate-y-1">
      ...
      <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-2 rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-200 text-sm font-medium shadow-md hover:shadow-lg transform hover:scale-105">
        Add to cart ⊕
      </button>
    </div>
  );
        ...
        <div className="bg-white rounded-xl shadow-md p-4 mb-8 border border-gray-200">
          <div className="flex flex-wrap gap-3">
            {categories.map((category, index) => (
              <button
                key={index}
                className="px-4 py-2 border-2 border-gray-300 rounded-full text-sm font-medium hover:border-blue-400 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200"
              >
                {category}
              </button>
            ))}
                ...
                <div className="flex items-center space-x-4 flex-1">
                  <div className="relative">
                    <select 
                      ...
                      className="appearance-none bg-white border-2 border-gray-300 rounded-lg px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium hover:border-blue-400 transition-all duration-200"
                    >
                  ...
                  <div className="flex-1 max-w-md relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400 transition-all duration-200"
                    />
                  </div>
                  
                  <div className="relative">
                    <select className="appearance-none bg-white border-2 border-gray-300 rounded-lg px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium hover:border-blue-400 transition-all duration-200">
